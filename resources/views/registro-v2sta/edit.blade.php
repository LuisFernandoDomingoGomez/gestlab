        ...
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
                ...
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('reporte-muestreos.index') }}">Registro de Cilindros</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <span class="card-title">Datos de Instrumental y Lecturas</span>
                        </div>
                        <div class="card-body">
