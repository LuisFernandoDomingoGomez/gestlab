...
<input type="text" style="WIDTH: 400px; HEIGHT:20px "class="sinborde" id="Id_trabajador" name='Id_trabajador' value="{{Session::get('sesionidt')}}" hidden />
  ...
  padding:0cm 3.5pt 0cm 3.5pt'>
  <h2 style='margin-bottom:0cm;margin-bottom:.0001pt'><span lang=ES>Caracteristicas del concreto solicitado</span></h2>
  
  <p class=MsoNormal><input type="text" style="WIDTH: 150px; HEIGHT:20px " class="sinborde" name="Id_expediente" id="Id_expediente" value='' placeholder="Id Expediente">
</span></b></p>
 ...
 <tr style='mso-yfti-lastrow:yes;page-break-inside:avoid'>
  ...
  12.0pt;font-family:"Arial",sans-serif'>FECHA DE ELABORACI&Oacute;N<br>
     ...
     <p class=MsoNormal><input type="date" id="Fecha_Elaboracion" name="Fecha_Elaboracion" value='' class='sinborde'></p>
  ...
  <p class=MsoNormal><input type="time" value='' class='sinborde' id='Hora_Elaboracion' name='Hora_Elaboracion'></p>
...
<p class=MsoNormal>
  ...
  <p class=MsoNormal> <input type="text" style="WIDTH: 80px; HEIGHT:20px "class="sinborde" name='Edo_civil' id="Edo_civil" value='' placeholder="Edo_civil:" required  />
 ...
 <tr style='page-break-inside:avoid'>
  ...
  <p class=MsoNormal><input type="date" size="25" maxlength="20" name="fechan" id="fechan" class="sinborde" value='' >
 </span>  </p>
  ...
  <p class=MsoNormal> <input type="text" style="WIDTH: 216px; HEIGHT:20px " class="sinborde" name="Ocupacion" id="Ocupacion"  placeholder="Escriba ocupaci&oacute;n:" value=''>
 ...
 <p class=MsoNormal> <input type="text" style="WIDTH: 216px; HEIGHT:20px " class="sinborde" name="Lugar_trabajo" id="Lugar_trabajo"  placeholder="Escriba lugar de trabajo:" value=''>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  <p class=MsoNormal> <input type="text" style="WIDTH: 216px; HEIGHT:20px " class="sinborde" name="Procedencia" id="Procedencia"  placeholder="Escriba su procedencia:" value='' >
  </td>
  ...
  <p class=MsoNormal>
  <input type="text" style="WIDTH: 216px; HEIGHT:20px " class="sinborde" name="Lugar_accidente" id="Lugar_accidente"  placeholder="Escriba el lugar del accidente:" value=''>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  <h2><span lang=ES>NOMBRE DEL RESPONSABLE DEL PACIENTE</span></h2>
     <p class=MsoNormal> <input type="text" style="WIDTH: 450px; HEIGHT:20px " class="sinborde" name="Nombre_Tutor" id="Nombre_Tutor"  placeholder="Escriba nombre completo:" value='' >
  ...
  <h2><span lang=ES>PARENTESCO CON EL PACIENTE</span></h2>
    <p class=MsoNormal> <input type="text" style="WIDTH: 150px; HEIGHT:20px " class="sinborde" name="Parentesco_Tutor" id="Parentesco_Tutor"  placeholder="Escriba parentesco:" value='' >
 ...
 <tr style='page-break-inside:avoid'>
  ...
  <input type="text" style="WIDTH: 60px; HEIGHT:20px " id="tvia" name="tvia" class='sinborde' placeholder="Tipo Via" value='' >:
 <input type="text" style="WIDTH: 140px; HEIGHT:20px " id="via"  name="via" class='sinborde' placeholder="Nombre Via" value=''>,
 <input type="text" style="WIDTH: 56px; HEIGHT:20px " id="ta"  name="ta" class='sinborde' placeholder="Tipo A." value=''> :
 <input type="text" style="WIDTH: 170px; HEIGHT:20px " id="na"  name="na" class='sinborde' placeholder="Nombre Asentamiento" value='' >, 
 No.Int.:<input type="number" style="WIDTH: 50px; HEIGHT:20px " id="nint"  name="nint"  class='sinborde' value=''>,
 No.Ext.:<input type="number" style="WIDTH: 50px; HEIGHT:20px " id="n_ext"  name="n_ext"  class='sinborde' value='' >,
C.P.:<input type="number" style="WIDTH: 60px; HEIGHT:20px " id="cp"  name="cp"  class='sinborde' value=''>,
<input type="text" style="WIDTH: 140px; HEIGHT:20px " id="loc"  name="loc" class='sinborde' placeholder="Localidad:" value=''>,
<input type="text" style="WIDTH: 140px; HEIGHT:20px " id="mun"  name="mun" class='sinborde' placeholder="Municipio:" value=''>,
<input type="text" style="WIDTH: 140px; HEIGHT:20px " id="edo"  name="edo" class='sinborde' placeholder="Estado:" value=''>
  </td>
  <td width=234 colspan=4 valign=top style='width:175.25pt;border:none;
  border-bottom:solid windowtext 1.0pt;mso-border-top-alt:solid windowtext .5pt;
  mso-border-left-alt:solid windowtext .5pt;mso-border-top-alt:solid windowtext .5pt;
  ...
  <p class=MsoNormal>
    <input type="text" style="WIDTH: 200px; HEIGHT:20px " class="sinborde" name="tel" id="tel"  placeholder="Escriba tel&eacute;fono:"  value='' >
...
<td width=712 colspan=11 style='width:620.95pt;border:none;border-bottom:solid windowtext 1.0pt;
  ...
  mso-border-bottom-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;
  height:14.2pt'>
    <p class=MsoNormal> <textarea rows="2" cols="86" class="sinborde" name="Antecedentes_RU" id="Antecedentes_RU"  placeholder="Escriba antecedentes relacionados con la urgencia:">
</textarea>
  </td>
 </tr>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-bottom-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt'>
 <p class=MsoNormal> <textarea rows="2" cols="86" class="sinborde" name="Padecimiento_A" id="Padecimiento_A"  placeholder="Escriba padecimiento actual:">
</textarea>
 </td>
 </tr>
 <tr style='page-break-inside:avoid'>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  padding:0cm 3.5pt 0cm 3.5pt'>
    <p class=MsoNormal>
	<textarea rows="2" cols="86" class="sinborde" name="Exploracion_fisica" id="Exploracion_fisica"  placeholder="Exploración fisica:">
</textarea>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  padding:0cm 3.5pt 0cm 3.5pt'>
 <p class=MsoNormal>
	<textarea rows="2" cols="86" class="sinborde" name="Resultados_lab" id="Resultados_lab"  placeholder="Escriba los resultados de laboratorio, gabinete y otros:">
</textarea>
  </td>
 </tr>
 <tr style='page-break-inside:avoid'>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  padding:0cm 3.5pt 0cm 3.5pt'>
  <p class=MsoNormal>
	<textarea rows="2" cols="86" class="sinborde" name="Diagnostico_pre" id="Diagnostico_pre"  placeholder="Escriba diagnostico(s) presuncional(es):">
</textarea>
 ...
 <tr style='page-break-inside:avoid'>
  ...
  padding:0cm 3.5pt 0cm 3.5pt'>
  <p class=MsoNormal>
	<textarea rows="2" cols="86" class="sinborde" name="Tratamiento_realizado" id="Tratamiento_realizado"  placeholder="Escriba tratamiento realizado:">
</textarea>
   </td>
 </tr>
 <tr style='page-break-inside:avoid;height:30.45pt'>
  ...
  <p class=MsoNormal><center><input type="radio" name="Caso_Medico" id="Caso_Medico" value="Si" /> Si   
 ...
 <p class=MsoNormal><center><input type="radio" name="Notificacion_ministerio" id="Notificacion_ministerio"  value="Si" /> Si   
 ...
 <p class=MsoNormal> 
 <input type="text" style="WIDTH: 230px; HEIGHT:20px " class="sinborde" name="Fila1" id="Fila1"  placeholder="Escriba nombre completo:" value='' >
 ...
 <td width=237 colspan=4 valign=top style='width:177.95pt;border-top:none;
  ...
  CAPACIDADES DIFERENTES<o:p></o:p></span></h3>
   ...
   <p class=MsoNormal> 
 <input type="text" style="WIDTH: 230px; HEIGHT:20px " class="sinborde" name="Fila2" id="Fila2"  placeholder="Escriba nombre completo:" value='' >
...
<b style='mso-bidi-font-weight:
  ...
  RESPONSABLE EN CASO DE ALTA VOLUNTARIA<o:p></o:p></span></b></p><br>
    <p class=MsoNormal> 
 <input type="text" style="WIDTH: 210px; HEIGHT:20px " class="sinborde" name="Fila3" id="Fila3"  placeholder="Escriba nombre completo:" value='' >
 ...
 <tr style='mso-yfti-lastrow:yes;page-break-inside:avoid'>
  ...
  <tr>
  <td style="width:60px"><h5><input type="radio" name="Destino" id="Destino" value="1" />OBSERVACIÓN</h5></td>  
  ...
  <p class=MsoNormal>
  <input type="text" style="WIDTH: 80px; HEIGHT:20px " id="Apellido_PU" name="Apellido_PU" class="sinborde"  value=""  readonly> 
  <input type="text" style="WIDTH: 80px; HEIGHT:20px " id="Apellido_MU" name="Apellido_MU" value="" class="sinborde"readonly><br>
<input type="text" style="WIDTH: 100px; HEIGHT:20px " id="NombreU" name="NombreU"class="sinborde" value=""  readonly>
