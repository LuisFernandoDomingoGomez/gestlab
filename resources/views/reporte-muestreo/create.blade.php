                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <span class="card-title">Generar Reporte de Muestreo</span>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('reporte-muestreos.store') }}"  role="form" enctype="multipart/form-data">
                                @csrf
